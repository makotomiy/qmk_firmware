...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK_DH] = LAYOUT_ortho_5x14_mod(
        ...
        KC_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_ESC,  KC_RGUI, KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_ENT,
                 KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_TAB,  KC_DEL,  KC_K,    KC_H,    KC_COMM, KC_DOT,  BR_SLSH,  
                          TD_SALT, TD_SCTL, FUNC,    KC_SPC,  NUMPAD,  NUMPAD,  KC_LSFT, LOWER,   RAISE,   KC_CAPS
    ),
    [_ACCENTS] = LAYOUT_ortho_5x14_mod(
        ...
        _______, KC_0,    KC_6,    KC_5,    KC_4,    BR_MINS, KC_F11,  KC_F12,  GRAV_A,  ACUT_A,  ACUT_E,  ACUT_I,  ACUT_O, _______,
                 XXXXXXX, KC_9,    KC_8,    KC_7,    KC_DOT,  _______, _______, BR_TILD, CIRC_A,  CIRC_E,  DIAE_U,  CIRC_O, 
    ...
    [_SYMBOL] = LAYOUT_ortho_5x14_mod(
        ...
        _______, BR_QUES, BR_DQUO, BR_QUOT, BR_LCBR, BR_RCBR, _______, _______, BR_COLN, BR_EQL,  KC_MINS, KC_PLUS, BR_EXLM, _______,
    ...
    [_NUMPAD] = LAYOUT_ortho_5x14_mod(
        ...
        _______, XXXXXXX, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, C(BR_SLSH), BR_LBRC, KC_MINS, KC_4,    KC_5,    KC_6,    KC_0,    _______,
                 C(KC_Z), C(KC_X), C(KC_C), XXXXXXX, C(KC_V), _______,    BR_RBRC, KC_DOT,  KC_1,    KC_2,    KC_3,    BR_ASTR,  
                          _______, _______, _______, _______, _______,    _______, KC_TAB,  KC_0,    KC_DOT,  KC_COMM
    )
};
