...
// C() macro directing to GUI. Changed to G() instead
// KC_RGUI directing to CTRL. Changed to KC_RCTL

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK_DH] = LAYOUT_ortho_4x13_mod(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,             KC_K,    KC_H,    KC_COMM, KC_DOT,  BR_SLSH, KC_RGUI,
                                   TD_SALT, TD_SCTL, FNSPC,   NUMPAD,  KC_LSFT, LOWER,   RAISE
    ),
    [_ACCENTS] = LAYOUT_ortho_4x13_mod(
    ...
    [_SYMBOL] = LAYOUT_ortho_4x13_mod(
        ...
        _______, BR_BSLS, BR_AT,   BR_ASTR, BR_LBRC, BR_RBRC,          BR_DLR,  BR_HASH, D_TILD,  D_CIRC,  _______, _______,
                                   _______, _______, KC_UNDS, _______, _______, _______, _______
    ),
    [_RAISE] = LAYOUT_ortho_4x13_mod(
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, S(KC_TAB),        KC_PGUP, KC_HOME, KC_UP,   KC_END,  XXXXXXX, KC_DEL,
        _______, XXXXXXX, KC_LALT, KC_LGUI, KC_LSFT, C(BR_SLSH),       KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT,XXXXXXX, _______,
    ...
    [_NUMPAD] = LAYOUT_ortho_4x13_mod(  
        _______, XXXXXXX, XXXXXXX, C(KC_F), XXXXXXX, S(KC_TAB),        BR_SLSH, KC_7,    KC_8,    KC_9,    BR_ASTR, _______,
        _______, XXXXXXX, KC_LALT, KC_LGUI, KC_LSFT, C(BR_SLSH),       KC_MINS, KC_4,    KC_5,    KC_6,    KC_0,    _______,
