...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK_DH] = LAYOUT_ortho_5x14_mod(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,                      KC_K,    KC_H,    KC_COMM, KC_DOT,  BR_SLSH, KC_RGUI,
                                   TD_SALT, TD_SCTL, FNSPC,   NUMTAB,  NUMPAD,  KC_LSFT, LOWER,   RAISE
    ),
    [_ACCENTS] = LAYOUT_ortho_5x14_mod(
        _______, XXXXXXX, KC_3,    KC_2,    KC_1,    BR_DIAE,                   BR_ACUT, TILD_A,  ACUT_U,  BR_CCED, TILD_O, _______,
        _______, KC_0,    KC_6,    KC_5,    KC_4,    BR_RBRC,                   GRAV_A,  ACUT_A,  ACUT_E,  ACUT_I,  ACUT_O, _______,
        _______, XXXXXXX ,KC_9,    KC_8,    KC_7,    BR_LBRC,                   BR_TILD, CIRC_A,  CIRC_E,  DIAE_U,  CIRC_O, _______,
    ...
    [_SYMBOL] = LAYOUT_ortho_5x14_mod(
        ...
        _______, BR_EXLM, BR_DQUO, BR_QUOT, BR_LPRN, BR_RPRN,                   BR_COLN, BR_EQL,  KC_MINS, KC_PLUS, BR_QUES, _______,
        _______, BR_BSLS, BR_AT,   BR_ASTR, BR_LBRC, BR_RBRC,                   BR_DLR,  BR_HASH, D_TILD,  D_CIRC,  _______, _______,
                                   _______, _______, KC_UNDS, _______, _______, _______, _______, _______
    ),
    [_RAISE] = LAYOUT_ortho_5x14_mod(
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, S(KC_TAB),                 KC_PGUP, KC_HOME, KC_UP,   KC_END,  XXXXXXX, KC_DEL,
        _______, XXXXXXX, KC_LALT, KC_LCTL, KC_LSFT, C(BR_SLSH),                KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT,XXXXXXX, _______,
        _______, C(KC_Z), C(KC_X), C(KC_C), XXXXXXX, C(KC_V),                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                                   _______, _______, KC_SPC,  _______, _______, _______, _______, _______
    ),
    [_NUMPAD] = LAYOUT_ortho_5x14_mod(  
        _______, XXXXXXX, XXXXXXX, C(KC_F), XXXXXXX, S(KC_TAB),                 BR_SLSH, KC_7,    KC_8,    KC_9,    BR_ASTR, _______,
        _______, XXXXXXX, KC_LALT, KC_LCTL, KC_LSFT, C(BR_SLSH),                KC_MINS, KC_4,    KC_5,    KC_6,    KC_0,    _______,
        _______, C(KC_Z), C(KC_X), C(KC_C), XXXXXXX, C(KC_V),                   KC_DOT,  KC_1,    KC_2,    KC_3,    KC_PLUS, _______,
                                   _______, _______, KC_SPC,  _______, _______, KC_TAB,  KC_0,    KC_COMM
    ),
    [_FUNCTION] = LAYOUT_ortho_5x14_mod(
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, S(KC_TAB),                 XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,
        _______, XXXXXXX, KC_LALT, KC_LCTL, KC_LSFT, C(BR_SLSH),                XXXXXXX, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,
        _______, C(KC_Z), C(KC_X), C(KC_C), XXXXXXX, C(KC_V),                   XXXXXXX, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
                                   _______, _______, KC_CAPS, _______, _______, _______, _______, _______
    )
};
