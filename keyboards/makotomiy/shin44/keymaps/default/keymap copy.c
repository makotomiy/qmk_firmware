...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK_DH] = LAYOUT_ortho_5x14_mod(
        KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,                      KC_J,    KC_L,    KC_U,    KC_Y,    BR_SCLN, KC_BSPC,
        KC_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,                      KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_ENT,
        KC_ESC,  KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,                      KC_K,    KC_H,    KC_COMM, KC_DOT,  BR_SLSH, KC_RGUI,
                          TD_SALT, TD_SCTL, FUNC,    KC_SPC,  KC_TAB,  NUMPAD,  KC_LSFT, LOWER,   RAISE
    ),
    [_ACCENTS] = LAYOUT_ortho_5x14_mod(
        _______, XXXXXXX, KC_3,    KC_2,    KC_1,    BR_SLSH,                   BR_ACUT, TILD_A,  ACUT_U,  BR_CCED, TILD_O, _______,
        _______, KC_0,    KC_6,    KC_5,    KC_4,    BR_MINS,                   GRAV_A,  ACUT_A,  ACUT_E,  ACUT_I,  ACUT_O, _______,
        _______, XXXXXXX, KC_9,    KC_8,    KC_7,    KC_DOT,                    BR_TILD, CIRC_A,  CIRC_E,  DIAE_U,  CIRC_O, _______,
                                   _______, _______, _______, _______, _______, _______, _______, _______
    ),
    [_SYMBOL] = LAYOUT_ortho_5x14_mod(
        _______, BR_PIPE, BR_SCLN, BR_AMPR, BR_LPRN, BR_RPRN,                   D_GRAV,  BR_PERC, KC_LT,   KC_GT,   D_ACUT,  _______,
        _______, BR_QUES, BR_DQUO, BR_QUOT, BR_LCBR, BR_RCBR,                   BR_COLN, BR_EQL,  KC_MINS, KC_PLUS, BR_EXLM, _______,
    ...
    [_RAISE] = LAYOUT_ortho_5x14_mod(
        ...
        _______, C(KC_Z), C(KC_X), C(KC_C), XXXXXXX, C(KC_V), _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                                   _______, _______, _______, _______, _______, _______, _______, _______
    ),
    [_NUMPAD] = LAYOUT_ortho_5x14_mod(
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   BR_SLSH, KC_7,    KC_8,    KC_9,    KC_PLUS, _______,
        _______, XXXXXXX, KC_LALT, KC_LCTL, KC_LSFT, C(BR_SLSH),                KC_MINS, KC_4,    KC_5,    KC_6,    KC_0,    _______,
        _______, C(KC_Z), C(KC_X), C(KC_C), XXXXXXX, C(KC_V),                   KC_DOT,  KC_1,    KC_2,    KC_3,    BR_ASTR, _______,   
                                   _______, _______, _______, _______, _______, KC_TAB,  KC_0,    KC_COMM
    )
};
